...
import balancer.controller.UsuariosController;
...
public class UsuariosViewController {
    ...
    @FXML public void initialize(){
        ...
        datos.setAll(controller.listar());
        tabla.setItems(datos);
    }
    @FXML public void agregar(){
        if(!controller.puedeGestionar()) return;
        controller.agregar(txtUsuario.getText(), txtPass.getText(), txtNombre.getText(), cbRol.getValue());
        datos.setAll(controller.listar());
